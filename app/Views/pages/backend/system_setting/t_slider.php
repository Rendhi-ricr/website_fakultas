...
<?= $this->section('title') ?>Tambah Slider<?= $this->endSection() ?>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control mb-3" id="link">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <label class="form-label" for="form-repeater-1-1-4-1">Date</label>
                            </div>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <label class="form-label" for="form-repeater-1-1-4-1">Time</label>
