<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- agenda -->
        <li class="menu-item">
            <a href="<?= site_url() ?>/Admin/Agenda" class="menu-link">
        ...
        <li class="menu-item">
            <a href="<?= site_url() ?>/Admin/Page" class="menu-link">
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Sistem Setting">System Setting</div>
            </a>

            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="<?= site_url() ?>/Admin/System" class="menu-link">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="<?= site_url() ?>/Admin/mp" class="menu-link">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="<?= site_url() ?>/Admin/Slider" class="menu-link">
        ...
        <li class="menu-item">
            <a href="<?= site_url() ?>/Admin/Gallery" class="menu-link">
        ...
        <li class="menu-item">
            <a href="<?= site_url() ?>/Admin/Message" class="menu-link">
        ...
        <li class="menu-item">
            <a href="<?= site_url() ?>/Admin/Staff" class="menu-link">

                <i class="menu-icon tf-icons ti ti-notebook"></i>
                <div data-i18n="Staff">Contact</div>
            </a>
        </li>
        <!-- agenda -->
